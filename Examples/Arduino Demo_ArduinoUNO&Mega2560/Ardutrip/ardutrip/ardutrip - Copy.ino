...
//0 al TX del GPS
//1 al RX del GPS
String cadena;              // Guardo las tramas del GPS
...
void pinta(char *msg, int tsize, int pos_x, int pos_y) {
  tft.fillRect(pos_x, pos_y, 240, tsize*8, ILI9341_BLACK);
...
void esperaPulsacion(void) {
 ...
 // p = ts.getPoint(); 
  ...
  if (p.z != -1) {
   ...
   salir++;
   //Pinto la evolución del contador
   pintaString(String(salir),1,120,220);
  }
/*   
